...
+ (OakPasteboard*)generalPasteboard  { return [OakPasteboard pasteboardWithName:@"通用" systemPasteboard:[NSPasteboard pasteboardWithName:NSGeneralPboard]  avoidsDuplicates:NO];  }
+ (OakPasteboard*)findPasteboard     { return [OakPasteboard pasteboardWithName:@"查找"    systemPasteboard:[NSPasteboard pasteboardWithName:NSFindPboard]     avoidsDuplicates:YES]; }
+ (OakPasteboard*)replacePasteboard  { return [OakPasteboard pasteboardWithName:@"替换" systemPasteboard:[NSPasteboard pasteboardWithName:OakReplacePboard] avoidsDuplicates:YES]; }

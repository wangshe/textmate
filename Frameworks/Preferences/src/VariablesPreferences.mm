...
- (void)loadView
{
	...
	NSTableColumn* nameTableColumn    = [self columnWithIdentifier:kVariableKeyName    title:@"变量名称" editable:YES width:140 resizingMask:NSTableColumnUserResizingMask];
	NSTableColumn* valueTableColumn   = [self columnWithIdentifier:kVariableKeyValue   title:@"值"         editable:YES width:200 resizingMask:NSTableColumnAutoresizingMask];

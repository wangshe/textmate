...
- (instancetype)initWithFrame:(NSRect)frameRect tabItem:(OakTabItem*)tabItem parent:(OakTabBarView*)tabBarView
{
	if(self = [super initWithFrame:frameRect])
	{
		...
		self.accessibilityRoleDescription = @"标签页";
...
- (OakRolloverButton*)closeButton
{
	if(!_closeButton)
	{
		...
		_closeButton.accessibilityLabel                 = @"关闭标签页";
...
- (OakRolloverButton*)overflowButton
{
	if(!_overflowButton)
	{
		...
		_overflowButton.accessibilityLabel = @"显示选项卡溢出菜单";
...
- (NSButton*)createNewTabButton
{
	if(!_createNewTabButton)
	{
		...
		_createNewTabButton.accessibilityLabel = @"创建新选项卡";
		...
		_createNewTabButton.toolTip    = @"创建新选项卡";

...
- (id)initWithFrame:(NSRect)aRect
{
	if(self = [super initWithFrame:aRect])
	{
		...
		self.createButton.toolTip       = @"新建文件";
		self.reloadButton.toolTip       = @"重载文件浏览";
		self.searchButton.toolTip       = @"搜索当前文件夹";
		self.favoritesButton.toolTip    = @"显示收藏";
		self.scmButton.toolTip          = @"显示源代码控制管理状态";

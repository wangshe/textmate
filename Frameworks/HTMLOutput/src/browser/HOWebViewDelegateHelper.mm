...
{
	NSAlert* alert = [NSAlert tmAlertWithMessageText:NSLocalizedString(@"脚本消息", @"JavaScript警告标题") informativeText:message buttons:NSLocalizedString(@"好", @"JavaScript警告确认"), nil];
...
- (BOOL)webView:(WebView*)sender runJavaScriptConfirmPanelWithMessage:(NSString*)message initiatedByFrame:(WebFrame*)frame
{
	...
	alert.messageText     = NSLocalizedString(@"脚本消息", @"JavaScript警告标题");
	alert.informativeText = message;
	[alert addButtons:NSLocalizedString(@"好", @"JavaScript警告确认"), NSLocalizedString(@"取消", @"JavaScript警告取消"), nil];

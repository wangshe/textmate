...
- (id)init
{
	if((self = [super init]))
	{
		_sourceListLabels = @[ @"所有", @"打开文档", @"未提交的文档" ];
...
- (void)updateWindowTitle
{
	...
	switch(self.sourceIndex)
	{
		...
		case kFileChooserOpenDocumentsSourceIndex:      src = @"打开文档";                               break;
		case kFileChooserUncommittedChangesSourceIndex: src = @"未提交的文档";                        break;
	}
	self.window.title = src ?: @"快速打开";
}
